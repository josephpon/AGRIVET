 ...
 * Use the [VetHome.newInstance] factory method to
...
class VetHome : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_vet_home, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment VetHome.
         */
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = MyAdapter()
        veterinarianRecyclerView.adapter = adapter
